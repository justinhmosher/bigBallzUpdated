...
urlpatterns = [
    ...
    path('confirm_forgot_email/<str:email>/',views.confirm_forgot_email,name='confirm_forgot_email'),
    ...
    path('create_forgot_email',views.create_forgot_email,name = 'create_forgot_email'),
